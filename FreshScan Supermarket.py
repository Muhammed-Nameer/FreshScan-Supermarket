...
def open_supermarket():
    ...
    root = Tk()        # <- This replaces Toplevel()
    ...
    # ===== FIXED WIDTHS BASED ON REFERENCE LAYOUT =====
    screen_w = root.winfo_screenwidth()
    screen_h = root.winfo_screenheight()

    left_w  = int(screen_w * 0.28)      # smaller like reference
    mid_w   = int(screen_w * 0.45)      # biggest section
    right_w = int(screen_w * 0.27)      # medium billing panel
